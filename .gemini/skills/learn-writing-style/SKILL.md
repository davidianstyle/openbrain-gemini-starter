...
Derive your writing-style profile from your real outbound messages and write it into `GEMINI.md §6`. The drafter skills (`/draft-follow-up`, `/daily-brief`, `/process-inbox`) read §6 as the source of truth, so updating §6 propagates automatically.
