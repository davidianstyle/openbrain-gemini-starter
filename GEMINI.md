...
This vault is **David Chang's OpenBrain**: a personal LYT (Linking Your Thinking) knowledge base where Gemini CLI is a first-class collaborator. Read this file at the start of every session in this vault.
...
- **Primary collaborator:** David Chang.
...
- **Drafting:** match David Chang's voice — direct.
...
**Generated by the [openbrain-gemini-starter](https://github.com/davidianstyle/openbrain-gemini-starter) bootstrap on `2026-04-24`.** Re-run `bootstrap/setup.sh` to update this file after adding new services.
